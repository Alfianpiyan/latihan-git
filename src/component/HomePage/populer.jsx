...
export default function Populer() {
  ...
  const { data, loading: loadingV2 } = useFetch("https://dummyjson.com/products/category/mens-watches");
  ...
  return (
    <div className="p-6 relative">
            ...
            <div className="flex items-center justify-between w-full mt-2">
              ...
              <FontAwesomeIcon
                ...
                onClick={(e) => {
                  ...
                  addToCart(product); // Ini untuk menambah ke keranjang umum
      ...
      {selectedProduct && (
        <div className="fixed inset-0 -mt-16 z-50 bg-black bg-opacity-50 overflow-y-auto">
          <div
              ...
              <div className="flex items-center gap-3">
                <button className="text-gray-800">
                  <FontAwesomeIcon
                    ...
                    onClick={(e) => {
                      e.stopPropagation(); // Mencegah modal tertutup saat mengklik ikon keranjang
                      addToCart(selectedProduct); // Ini untuk menambah ke keranjang umum dari modal
                      setToastMessage("Produk ditambahkan ke keranjang!");
                    }}
                  />
                </button>
