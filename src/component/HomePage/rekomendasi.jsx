...
export default function Rekomendasi() {
  ...
  const { data, loading: loadingV2 } = useFetch("https://dummyjson.com/products/category/smartphones?limit=6");
            ...
            <div className="flex items-center justify-between w-full mt-2">
              ...
              <FontAwesomeIcon
                ...
                onClick={(e) => {
                  ...
                  addToCart({ ...product, selected: false }); // Ini untuk menambah ke keranjang umum
              ...
              <div className="flex items-center gap-3">
                <button className="text-gray-800">
                  <FontAwesomeIcon
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      addToCart({ ...selectedProduct, selected: false }); // Ini untuk menambah ke keranjang umum dari modal
                      setToastMessage("Produk ditambahkan ke keranjang!");
                    }}
                  />
                </button>
